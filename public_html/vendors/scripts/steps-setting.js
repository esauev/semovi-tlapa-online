...
let isValidContainer = (index) => {
	...
	switch (index) {
		...
		case 3:
			...
			if (photo === false || signature === false || fingerprint === false || photoValid === false || signatureValid === false || fingerprintValid === false || photoSize === false || signatureSize === false || fingerprintSize === false) {
				return false
			}
			return true
		break;
